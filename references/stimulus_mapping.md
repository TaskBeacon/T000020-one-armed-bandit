...
| Cue | `fixation` | `DAW2006_NATURE` | Trial-by-trial bandit tasks include pre-choice fixation/ready interval. | `psychopy_builtin` | Neutral pre-choice fixation. |
...
| Feedback | `feedback_win`, `feedback_loss` | `DAW2006_NATURE`, `SCHULZ2019_PNAS` | Outcome feedback reflects stochastic reward from chosen option. | `psychopy_builtin` | Displays per-trial reward delta and running total. |
